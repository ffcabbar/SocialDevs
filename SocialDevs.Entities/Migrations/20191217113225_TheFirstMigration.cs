        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusId = table.Column<int>(nullable: true),
                    Text = table.Column<string>(nullable: true),
                    StorieType = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Stories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Stories_AppUser_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "AppUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Stories_AppUser_ModifiedBy",
                        column: x => x.ModifiedBy,
                        principalTable: "AppUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUrl = table.Column<string>(maxLength: 100, nullable: true),
                    PostId = table.Column<int>(nullable: false),
                    StorieId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StorieImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StorieImages_AppUser_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "AppUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StorieImages_AppUser_ModifiedBy",
                        column: x => x.ModifiedBy,
                        principalTable: "AppUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StorieImages_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_StorieImages_Stories_StorieId",
                        column: x => x.StorieId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StorieVideos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StorieVideos_AppUser_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "AppUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StorieVideos_AppUser_ModifiedBy",
                        column: x => x.ModifiedBy,
                        principalTable: "AppUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StorieVideos_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_StorieVideos_Stories_StorieId",
                        column: x => x.StorieId,
                        principalTable: "Stories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StorieImages_CreatedBy",
                table: "StorieImages",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_StorieImages_ModifiedBy",
                table: "StorieImages",
                column: "ModifiedBy");

            migrationBuilder.CreateIndex(
                name: "IX_StorieImages_PostId",
                table: "StorieImages",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_StorieImages_StorieId",
                table: "StorieImages",
                column: "StorieId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StorieVideos_CreatedBy",
                table: "StorieVideos",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_StorieVideos_ModifiedBy",
                table: "StorieVideos",
                column: "ModifiedBy");

            migrationBuilder.CreateIndex(
                name: "IX_StorieVideos_PostId",
                table: "StorieVideos",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_StorieVideos_StorieId",
                table: "StorieVideos",
                column: "StorieId");
